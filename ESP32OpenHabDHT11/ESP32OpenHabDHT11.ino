...
//Datos de WiFi
const char* ssid = "Docentes"; // Aquí debes poner el nombre de tu red
//const char* password = "1F349952";  // Aquí debes poner la contraseña de tu red
const char* password = "$doc19_S3p";

//Datos del broker MQTT
const char* mqtt_server = "172.16.80.228"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
IPAddress server(172,16,80,228);
